        ...
        (function () {
          ...
          (e || 0 !== e.length) &&
            e.forEach(function (e) {
              "1" !== e.getAttribute("data-kt-initialized") &&
                (a(e), e.setAttribute("data-kt-initialized", "1"));
            });
        })(),
        (e = !0);
    },
...
var KTAppSidebar = (function () {
  ...
  return {
    init: function () {
      var t;
      (e = document.querySelector("#kt_app_sidebar_menu_wrapper")) &&
        (t = e.querySelector(".menu-link.active")) &&
        !0 !== KTUtil.isVisibleInContainer(t, e) &&
        e.scroll({
          top: KTUtil.getRelativeTopPosition(t, e),
          behavior: "smooth",
        });
    },
  };
